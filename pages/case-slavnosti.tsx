    ...
    <div className={isQuoteModalShown ? 'page-overlay' : ''}>
      ...
      <div className="container page-content pb-6">
        ...
        <div className="row mt-5">
          ...
          <div className="col-sm-8">
            <p>We've built the website as from scratch with HTML, CSS, JavaScript and PHP. We didn't use any front-end or back-end framework. During the work, we followed the best practices for asset optimization to make sure website will load fast, even on low-end devices and slow internet connection.</p>
